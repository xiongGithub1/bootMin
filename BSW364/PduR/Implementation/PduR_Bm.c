...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_Bm_Init_TxBufferInstance(PduR_MemIdxType memIdx)
{
  ...
  for(bmTxBufferInstanceRomIdx = 0u; bmTxBufferInstanceRomIdx < PduR_GetSizeOfBmTxBufferInstanceRam(memIdx); bmTxBufferInstanceRomIdx++)  /* FETA_PDUR_01 */
  {
...
# endif
    {
      for(bmTxBufferRomIndIdx = bmTxBufferRomIndStartId; bmTxBufferRomIndIdx < bmTxBufferRomIndEndIdx; bmTxBufferRomIndIdx++) /* COV_PDUR_ONLY_SHARED_OR_DEDICATED_BUFFER */  /* FETA_PDUR_01 */
      {
