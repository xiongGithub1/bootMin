...
# endif
  ...
  }
  {
    ...
    for(fmFifoInstanceRamIdx = 0u; fmFifoInstanceRamIdx < PduR_GetSizeOfFmFifoInstanceRam(memIdx); fmFifoInstanceRamIdx++)  /* FETA_PDUR_01 */
    {
...
{
  Std_ReturnType retVal = E_NOT_OK;     /* PRQA S 2981 */ /* MD_MSR_RetVal */
  PduR_FmFifoInstanceRomPartitionIdxOfRmGDestRomType memIdx = PduR_GetFmFifoInstanceRomPartitionIdxOfRmGDestRom(rmGDest);
