...
PDUR_LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_TxInst_UpTransmit(PduR_RmGDestRomIterType rmGDestRomIdx)
{
  ...
  {
    PduR_FmFifoInstanceRomPartitionIdxOfRmGDestRomType memIdx = PduR_GetFmFifoInstanceRomPartitionIdxOfRmGDestRom(rmGDestRomIdx);
...
FUNC(Std_ReturnType, PDUR_CODE) PduR_RmTp_TxInst_TriggerTransmit(PduR_RmDestRomIterType rmDestRomIdx, PduR_RmGDestRomIterType rmGDestRomIdx)
{
  ...
  PduR_RmGDestTpTxStateRamPartitionIdxOfRmGDestRomType memIdx = PduR_GetRmGDestTpTxStateRamPartitionIdxOfRmGDestRom(rmGDestRomIdx);
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmTp_TxInst_TxConfirmation_RmTxInstActiveOrRmTxInstAborted(PduR_RmGDestRomIterType rmGDestRomIdx, Std_ReturnType result)
{
  PduR_FmFifoInstanceRomPartitionIdxOfRmGDestRomType fmFifoInstanceRamMemIdx = PduR_GetFmFifoInstanceRomPartitionIdxOfRmGDestRom(rmGDestRomIdx);
  PduR_RmGDestTpTxStateRamPartitionIdxOfRmGDestRomType rmGDestTpTxStateRamMemIdx = PduR_GetRmGDestTpTxStateRamPartitionIdxOfRmGDestRom(rmGDestRomIdx);
  PduR_BmTxBufferInstanceRomIterType bmTxBufferInstanceRomIdx;

  PduR_SetTpTxInstSmStateOfRmGDestTpTxStateRam(PduR_GetRmGDestTpTxStateRamIdxOfRmGDestRom(rmGDestRomIdx), PDUR_RM_TXINST_IDLE_TPTXINSTSMSTATEOFRMGDESTTPTXSTATERAM, rmGDestTpTxStateRamMemIdx);        /* SBSW_PDUR_CSL03 */

  if(PduR_Fm_GetCurrentlyUsedBmTxBufferInstanceIdxByRmGDestIdx(rmGDestRomIdx, &bmTxBufferInstanceRomIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
  {
    PduR_Bm_ResetTxBufferInstance(bmTxBufferInstanceRomIdx, fmFifoInstanceRamMemIdx);
  }
  PduR_RmTp_FinishTransmission_TpTxSmStateHandler(PduR_GetFmFifoRomIdxOfFmFifoInstanceRom(PduR_GetFmFifoInstanceRomIdxOfRmGDestRom(rmGDestRomIdx), fmFifoInstanceRamMemIdx), result, fmFifoInstanceRamMemIdx);
  PDUR_DUMMY_STATEMENT(result); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  PDUR_DUMMY_STATEMENT(rmGDestTpTxStateRamMemIdx); /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
}
#endif
...
FUNC(void, PDUR_CODE) PduR_RmTp_TxInst_CancelTransmit(PduR_RmDestRomIterType rmGDestRomIdx)
{
  ...
  switch (PduR_GetTpTxInstSmStateOfRmGDestTpTxStateRam(rmGDestTpTxStateRamIdx, rmGDestTpTxStateRamMemIdx))
  {
    case PDUR_RM_TXINST_IDLE_TPTXINSTSMSTATEOFRMGDESTTPTXSTATERAM:
      /* Nothing to abort. */
      break;
    ...
    case PDUR_RM_TXINST_ACTIVE_TPTXINSTSMSTATEOFRMGDESTTPTXSTATERAM:
      PduR_SetTpTxInstSmStateOfRmGDestTpTxStateRam(rmGDestTpTxStateRamIdx, PDUR_RM_TXINST_ABORTED_TPTXINSTSMSTATEOFRMGDESTTPTXSTATERAM, rmGDestTpTxStateRamMemIdx); /* SBSW_PDUR_CSL01 */
      break;
...
# if (PDUR_EXISTS_DEFERRED_PDURDESTPDUPROCESSINGOFRMGDESTROM == STD_ON)
    case PDUR_RM_TXINST_WAITING_TPTXINSTSMSTATEOFRMGDESTTPTXSTATERAM:
    {
      ...
      PduR_SetTpTxInstSmStateOfRmGDestTpTxStateRam(rmGDestTpTxStateRamIdx, PDUR_RM_TXINST_IDLE_TPTXINSTSMSTATEOFRMGDESTTPTXSTATERAM, rmGDestTpTxStateRamMemIdx);        /* SBSW_PDUR_CSL03 */

      if(PduR_Fm_GetCurrentlyUsedBmTxBufferInstanceIdxByRmGDestIdx(rmGDestRomIdx, &bmTxBufferInstanceRomIdx) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* COV_PDUR_ROBUSTNESS */
      {
        PduR_Bm_ResetTxBufferInstance(bmTxBufferInstanceRomIdx, fmFifoInstanceRamMemIdx);
      }
      PduR_RmTp_FinishTransmission_TpTxSmStateHandler(PduR_GetFmFifoRomIdxOfFmFifoInstanceRom(PduR_GetFmFifoInstanceRomIdxOfRmGDestRom(rmGDestRomIdx), fmFifoInstanceRamMemIdx), E_NOT_OK, fmFifoInstanceRamMemIdx);
    }
      break;
# endif
  ...
  PDUR_DUMMY_STATEMENT(fmFifoInstanceRamMemIdx);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
  PDUR_DUMMY_STATEMENT(rmGDestTpTxStateRamMemIdx);       /* PRQA S 1338, 2983, 3112 */ /* MD_MSR_DummyStmt */ /* lint -e{438} */
}
#endif
