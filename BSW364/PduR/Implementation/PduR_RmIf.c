...
# if(PDUR_RMGDESTNTO1INFORAMIDXOFRMGDESTROM == STD_ON)
    if(PduR_IsRmGDestNto1InfoRamUsedOfRmGDestRom(rmGDestRomIdx))
    {
      ...
      if(PduR_IsTransmissionActiveOfRmGDestNto1InfoRam(PduR_GetRmGDestNto1InfoRamIdxOfRmGDestRom(rmGDestRomIdx), PduR_GetRmGDestNto1InfoRamPartitionIdxOfRmGDestRom(rmGDestRomIdx)) && (foundSrcPdu == E_OK) && (rmDestRomIdx == lastTxdRmDestRomIdx))   /* COV_PDUR_ROBUSTNESS */
      {
...
#   endif
            {
              ...
              if(PduR_McQ_WriteTxConfirmation(PduR_GetMcQBufferRomIdxOfSrcApplicationRom(dest2srcApplicationRomIdx), rmSrcRomIdx, PduR_GetMcQBufferRomPartitionIdxOfSrcApplicationRom(dest2srcApplicationRomIdx)) == E_NOT_OK)
              {
...
# if (PDUR_EXISTS_DEFERRED_PDURDESTPDUPROCESSINGOFRMGDESTROM == STD_ON)
    case PDUR_DEFERRED_PDURDESTPDUPROCESSINGOFRMGDESTROM:
    {
      ...
      PduR_SetIfSmStateOfRmBufferedIfPropertiesRam(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(rmGDest), PDUR_RM_TX_IDLE_IFSMSTATEOFRMBUFFEREDIFPROPERTIESRAM, PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDest));      /* SBSW_PDUR_IDX_PARAM_INTERNAL_FUNCTION */
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmIf_FifoHandling(PduR_RmDestRomIterType rmDest, PduR_RmGDestRomIdxOfRmDestRomType rmGDest, P2CONST(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) info)
{
  ...
  PduR_RmBufferedIfPropertiesRomPartitionIdxOfRmGDestRomType memIdx = PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDest);
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmIf_Forward2Buffer(PduR_RmDestRomIterType rmDestIdx, P2CONST(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) info)
{
  ...
  switch (PduR_GetQueueTypeOfRmBufferedIfPropertiesRom(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(PduR_GetRmGDestRomIdxOfRmDestRom(rmDestIdx)), PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDest)))
  {
# if(PDUR_EXISTS_SINGLE_BUFFER_QUEUETYPEOFRMBUFFEREDIFPROPERTIESROM == STD_ON)
...
# if (PDUR_SMDATAPLANEROM == STD_ON)
    ...
    if(PduR_IsSmSrcRomUsedOfRmSrcRom(rmSrcIdx))
    {
      ...
      PduR_SmSrcRomPartitionIdxOfRmSrcRomType memIdx = PduR_GetSmSrcRomPartitionIdxOfRmSrcRom(rmSrcIdx);
...
# if (PDUR_SMDATAPLANEROM == STD_ON)
        ...
        if(PduR_IsSmGDestRomUsedOfRmGDestRom(rmGDestRomIdx))
        {
          ...
          PduR_SmSrcRomPartitionIdxOfRmSrcRomType memIdx = PduR_GetSmGDestRomPartitionIdxOfRmGDestRom(rmGDestRomIdx);
...
#  endif
            )   /* COV_PDUR_CROSSCORE_ROUTINGS_ONLY */
          {
            ...
            if(PduR_McQ_WriteData(PduR_GetMcQBufferRomIdxOfSrcApplicationRom(dest2srcApplicationRomIdx),
                                  ...
                                  info,
                                  PduR_GetMcQBufferRomPartitionIdxOfSrcApplicationRom(dest2srcApplicationRomIdx)) == E_OK)     /* SBSW_PDUR_VALID_PTR_ENSURED_BY_CALLING_FUNCTION */
            {
              retVal &= E_OK;
            }
            else
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_RmIf_TxConfirmation(PduR_RmGDestRomIdxOfTxIf2UpType rmGDestRomIdx)
{
  ...
  {
    switch (PduR_GetIfSmStateOfRmBufferedIfPropertiesRam(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(rmGDestRomIdx), PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDestRomIdx)))
    {
...
FUNC(void, PDUR_CODE) PduR_RmIf_TxConfirmation_StateHandler_RM_TX_ACTIVE(PduR_RmGDestRomIterType rmGDestRomIdx)
{
  ...
  if(PduR_QAL_Get(rmGDestRomIdx, &rmDestRomIdx, &destPduInfo) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */
  {
    if(E_OK != PduR_RmIf_MultipleSourceHandler_Transmit(rmDestRomIdx, &destPduInfo, TRUE))    /* SBSW_PDUR_API_CALL_FORWARDING_ID_AND_PTR */
    {
      ...
      PduR_SetIfSmStateOfRmBufferedIfPropertiesRam(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(rmGDestRomIdx), PDUR_RM_TX_IDLE_IFSMSTATEOFRMBUFFEREDIFPROPERTIESRAM, PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDestRomIdx));      /* SBSW_PDUR_IDX_PARAM_INTERNAL_FUNCTION */
...
PDUR_LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_QAL_Put(PduR_RmGDestRomIterType rmGDestRomIdx, PduR_RmDestRomIterType rmDestRomIdx, PduLengthType pduLength, SduDataPtrType sduDataPtr)
{
  return PduR_GetPutFctPtrOfQueueFctPtrRom(PduR_GetQueueFctPtrRomIdxOfRmBufferedIfPropertiesRom(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(rmGDestRomIdx), PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDestRomIdx))) (rmGDestRomIdx, rmDestRomIdx, pduLength, sduDataPtr); /* SBSW_PDUR_API_CALL_FORWARDING_ID_AND_PTR */
}
#endif
...
PDUR_LOCAL_INLINE FUNC(Std_ReturnType, PDUR_CODE) PduR_QAL_Get(PduR_RmGDestRomIterType rmGDestRomIdx, P2VAR(PduR_RmDestRomIterType, AUTOMATIC, PDUR_APPL_DATA) rmDestRomIdx, P2VAR(PduInfoType, AUTOMATIC, PDUR_APPL_DATA) info)
{
  return PduR_GetGetFctPtrOfQueueFctPtrRom(PduR_GetQueueFctPtrRomIdxOfRmBufferedIfPropertiesRom(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(rmGDestRomIdx), PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDestRomIdx))) (rmGDestRomIdx, rmDestRomIdx, info); /* SBSW_PDUR_API_CALL_FORWARDING_ID_AND_PTR */
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_QAL_Remove(PduR_RmGDestRomIterType rmGDestRomIdx)
{
  PduR_GetRemoveFctPtrOfQueueFctPtrRom(PduR_GetQueueFctPtrRomIdxOfRmBufferedIfPropertiesRom(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(rmGDestRomIdx), PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDestRomIdx))) (rmGDestRomIdx); /* SBSW_PDUR_API_CALL_FORWARDING_ID_ONLY */
}
#endif
...
PDUR_LOCAL_INLINE FUNC(uint16, PDUR_CODE) PduR_QAL_GetFillLevel(PduR_RmGDestRomIterType rmGDestRomIdx)
{
  return PduR_GetGetFillLevelFctPtrOfQueueFctPtrRom(PduR_GetQueueFctPtrRomIdxOfRmBufferedIfPropertiesRom(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(rmGDestRomIdx), PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDestRomIdx))) (rmGDestRomIdx); /* SBSW_PDUR_API_CALL_FORWARDING_ID_ONLY */
}
#endif
...
PDUR_LOCAL_INLINE FUNC(void, PDUR_CODE) PduR_QAL_Flush(PduR_RmGDestRomIterType rmGDestRomIdx)
{
  PduR_GetFlushFctPtrOfQueueFctPtrRom(PduR_GetQueueFctPtrRomIdxOfRmBufferedIfPropertiesRom(PduR_GetRmBufferedIfPropertiesRomIdxOfRmGDestRom(rmGDestRomIdx), PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDestRomIdx))) (rmGDestRomIdx); /* SBSW_PDUR_API_CALL_FORWARDING_ID_ONLY */
}
#endif
...
# if((PDUR_EXISTS_RX_DIRECTIONOFRMGDESTROM == STD_ON) && (PDUR_EXISTS_FIFO_QUEUETYPEOFRMBUFFEREDIFPROPERTIESROM == STD_ON))
        ...
        case PDUR_RX_DIRECTIONOFRMGDESTROM:
        {
          ...
          while(PduR_QAL_Get(rmGDestRomIdx, &rmDestRomIdx, &destPduInfo) == E_OK) /* SBSW_PDUR_STACK_VARIABLE */ /* FETA_PDUR_03 */
          {
...
FUNC(void, PDUR_CODE) PduR_RmIf_DisableRoutingAction(PduR_RmDestRomIterType rmDestRomIdx)
{
  ...
  PduR_RmBufferedIfPropertiesRomPartitionIdxOfRmGDestRomType memIdx = PduR_GetRmBufferedIfPropertiesRomPartitionIdxOfRmGDestRom(rmGDestIdx);
