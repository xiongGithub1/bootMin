...
#  error "The 64-bit endian conversion functions can only be overwritten, if PLATFORM_SUPPORT_SINT64_UINT64 is defined!"
# endif
...
#   error "Endian swap API mapping for 16-bit values has to be defined"
#  endif
# endif
...
#   error "Endian swap API mapping for 32-bit values has to be defined"
#  endif
# endif
...
#   error "Endian swap API mapping for 64-bit values has to be defined"
#  endif
# endif
  ...
  uint32_least nCnt)
{
  ...
  if(result == VSTDLIB_MEM_CMP_RES_EQ)
  {
    ...
    result = VStdLib_Loc_MemCmp_8( /* SBSW_VSTDLIB_CALL_NO_PTR_WRITE */
  ...
  uint8_least nBuf2Offset)
{
  ...
  result = VStdLib_Loc_MemCmp_8((P2CONST(uint8, AUTOMATIC, VSTDLIB_VAR_FAR))&pBuf1_32[0u], /* SBSW_VSTDLIB_CALL_NO_PTR_WRITE */
                                pBuf2_8, nBuf2Offset);
  ...
  if(result == VSTDLIB_MEM_CMP_RES_EQ)
  {
    ...
    /* Calculate byte displacement depending shift values */
    uint8_least prevShift = (nBuf2Offset << 3u) & VSTDLIB_MASK_31;
    uint8_least xShift = 32u - prevShift;
...
#  endif
    ...
    if(result == VSTDLIB_MEM_CMP_RES_EQ)
    {
      ...
      result = VStdLib_Loc_MemCmp_8((P2CONST(uint8, AUTOMATIC, VSTDLIB_VAR_FAR))&prev, /* SBSW_VSTDLIB_CALL_NO_PTR_WRITE */
...
# if (VSTDLIB_RUNTIME_OPTIMIZATION == STD_ON)
      ...
      if (nCnt < 32u)
      {
        ...
        result = VStdLib_Loc_MemCmp_8(pBuf1_8, pBuf2_8, nCnt); /* SBSW_VSTDLIB_CALL_NO_PTR_WRITE */
      }
      /* #130 Else */
      else
      {
        ...
        if (nBuf1Offset != 0u)
        {
          ...
          result = VStdLib_Loc_MemCmp_8(pBuf1_8, pBuf2_8, nBuf1Offset); /* SBSW_VSTDLIB_CALL_NO_PTR_WRITE */
        }
        ...
        if(result == VSTDLIB_MEM_CMP_RES_EQ)
        {
          ...
          if(nBuf2Offset == 0u)
          {
            ...
            result = VStdLib_Loc_MemCmp_32_Aligned( /* SBSW_VSTDLIB_CALL_NO_PTR_WRITE */
          ...
          else
          {
            ...
            result = VStdLib_Loc_MemCmp_32_Unaligned( /* SBSW_VSTDLIB_CALL_NO_PTR_WRITE */
                        (P2CONST(uint32, AUTOMATIC, VSTDLIB_VAR_FAR)) pBuf1_8, /* PRQA S 0310, 3305 */ /* MD_VStdLib_PtrCast */
                        pBuf2_8,
                        nCnt,
                        nBuf2Offset);
