...
#if defined (DET_PROCESSOR_CANOEEMU) /* COV_DET_CANOE_VTT */
...
#  if defined (VVIRTUALTARGET) /* COV_DET_CANOE_VTT */
 ...
 *  \synchronous TRUE
 **********************************************************************************************************************/
# if defined (DET_PROCESSOR_CANOEEMU)
...
DET_LOCAL_INLINE FUNC(void, DET_CODE) Det_CanoeOutput( uint16 ModuleId, uint8 InstanceId, uint8 ApiId, uint8 ErrorId )
{
#  if defined (DET_VTTUSECASE) /* COV_DET_CANOE_VTT */
