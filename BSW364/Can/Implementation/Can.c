...
#  endif
  {
    ...
    for (subSystemIndex = 0u; subSystemIndex<Can_GetSizeOfCanSubSystemBaseAdr(); subSystemIndex++)
    {
...
# endif
  ...
  if ((Cn->CCCR & kCanCCCR_INIT) != kCanCCCR_INIT ) /* If Init-Bit is not set */ /* PRQA S 2842,2843 */ /* MD_Can_Assertion,MD_Can_HL_DereferencePointerValue */
  {
    ...
    while( ((Cn->CCCR & kCanCCCR_INIT) == 0UL) && (CanLL_ApplCanTimerLoop(kCanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303,2842,2843 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess,MD_Can_Assertion,MD_Can_HL_DereferencePointerValue */ /* COV_CAN_HW_SPECIFIC */
  ...
  CanLL_ApplCanTimerStart(kCanLoopInit); /* PRQA S 2842 */ /* MD_Can_Assertion */ /* SBSW_CAN_LL_101 */
  while( ((Cn->CCCR & kCanCCCR_CCE) == 0UL) && (CanLL_ApplCanTimerLoop(kCanLoopInit) !=  CAN_NOT_OK) ) /* PRQA S 1881,4558,3415,0303,2842,2843 */ /* MD_MSR_AutosarBoolean,MD_Can_4558_RHsideEffect,MD_Can_4558_RHsideEffect,MD_Can_HwAccess,MD_Can_Assertion,MD_Can_HL_DereferencePointerValue */ /* COV_CAN_HW_SPECIFIC */
