...
))
{
  ...
  /* #20 Clear the bits for priority, VM and core assignment. */
  tempSRC &= (~OS_HAL_INT_SRC_SRPN_MASK & ~OS_HAL_INT_SRC_TOS_MASK & ~OS_HAL_INT_SRC_VM_MASK);
  ...
  Os_Hal_IntSetCurrentVM(tempSRC);
