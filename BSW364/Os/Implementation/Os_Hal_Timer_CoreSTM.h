...
))
{
  ...
  *(volatile uint32*)(TimerConfig->CMCONRegisterAddress) =                            /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_FRTCONFIG */
      ( (*(volatile uint32*)(TimerConfig->CMCONRegisterAddress)) & 
      TimerConfig->CMCONMask ) | TimerConfig->CMCONValue;                                                               /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */

  /* #20 Adjust the compare register with the reload value. If this is a HRT, the generated reload value should be 0. */
  *(volatile Os_Hal_TimerFrtTickType*)(TimerConfig->CompareRegisterAddress) = 
  TimerConfig->ReloadValue;                                                                                             /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_FRTCONFIG */
  ...
  *(volatile uint32*)(TimerConfig->ICRRegisterAddress) =                              /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */ /* SBSW_OS_HAL_PWA_FRTCONFIG */
      ( (*(volatile uint32*)(TimerConfig->ICRRegisterAddress)) & 
      TimerConfig->ICRMask ) | TimerConfig->ICRValue;                                                                   /* PRQA S 0303 */ /* MD_Os_Hal_Rule11.4_0303 */
