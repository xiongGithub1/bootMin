...
# define OS_START_SEC_OsTask_MainFunction_CODE
# include "Os_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */

/**********************************************************************************************************************
 *  OsTask_MainFunction()
 *********************************************************************************************************************/
extern FUNC(void, OS_OSTASK_MAINFUNCTION_CODE) Os_Task_OsTask_MainFunction(void);

# define OS_STOP_SEC_OsTask_MainFunction_CODE
# include "Os_MemMap.h" /* PRQA S 5087 */ /* MD_MSR_MemMap */
