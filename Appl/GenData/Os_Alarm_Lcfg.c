...
/*! Dynamic alarm data: OsAlarm_MainFunction_1ms */
OS_LOCAL VAR(Os_AlarmType, OS_VAR_NOINIT) OsCfg_Alarm_OsAlarm_MainFunction_1ms_Dyn;
...
CONST(Os_AlarmActivateTaskConfigType, OS_CONST) OsCfg_Alarm_OsAlarm_MainFunction_1ms =
{
  /* .Alarm = */
  {
    /* .Job                   = */
    {
      /* .Dyn      = */ OS_ALARM_CASTDYN_ALARM_2_JOB(OsCfg_Alarm_OsAlarm_MainFunction_1ms_Dyn),
      /* .Counter  = */ OS_COUNTER_CASTCONFIG_TIMERPFRT_2_COUNTER(OsCfg_Counter_SystemTimer),
      /* .Callback = */ Os_AlarmActionActivateTask
    },
    /* .Autostart             = */
    {
      /* .AlarmTime        = */ 2u, /* 0.002 sec */
      /* .Cycle            = */ 1u, /* 0.001 sec */
      /* .ApplicationModes = */ OSDEFAULTAPPMODE,
      /* .AlarmMode        = */ OS_ALARMMODE_RELATIVE
    },
    /* .AccessingApplications = */ OS_APPID2MASK(SystemApplication_OsCore0),  /* PRQA S 0410 */ /* MD_MSR_Dir1.1 */
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0
  },
  /* .Task  = */ &OsCfg_Task_OsTask_MainFunction
};
