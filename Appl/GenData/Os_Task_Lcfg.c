...
/*! Dynamic task data: OsTask_MainFunction */
OS_LOCAL VAR(Os_TaskType, OS_VAR_NOINIT) OsCfg_Task_OsTask_MainFunction_Dyn;
...
/*! Task configuration data: OsTask_MainFunction */
CONST(Os_TaskConfigType, OS_CONST) OsCfg_Task_OsTask_MainFunction =
{
  /* .Thread                 = */
  {
    /* .ContextConfig         = */ &OsCfg_Hal_Context_OsTask_MainFunction,
    /* .Context               = */ &OsCfg_Hal_Context_OsTask_MainFunction_Dyn,
    /* .Stack                 = */ &OsCfg_Stack_OsCore0_Task_Prio30,
    /* .Dyn                   = */ OS_TASK_CASTDYN_TASK_2_THREAD(OsCfg_Task_OsTask_MainFunction_Dyn),
    /* .OwnerApplication      = */ &OsCfg_App_SystemApplication_OsCore0,
    /* .Core                  = */ &OsCfg_Core_OsCore0,
    /* .IntApiState           = */ &OsCfg_Core_OsCore0_Dyn.IntApiState,
    /* .TimeProtConfig        = */ NULL_PTR,
