...
#define CDD_USE_DUMMY_STATEMENT STD_OFF /* /MICROSAR/vSet/vSetGeneral/vSetDummyStatementKind */
#endif
...
#endif
#ifndef CDD_PROCESSOR_TC387Q
#define CDD_PROCESSOR_TC387Q
#endif
...
#define CddConf_CddPduRUpperLayerRxPdu_CddPduRUpperLayerRxPdu_7df     1u
#define CddConf_CddPduRUpperLayerRxPdu_CddPduRUpperLayerRxPdu_74c     0u
/**\} */
...
/* Handle IDs active in all predefined variants (the application has not to take the active variant into account) */
/*      Symbolic Name                                                 Value   Active in predefined variant(s) */
#define CddConf_CddPduRUpperLayerTxPdu_CddPduRUpperLayerTxPdu_75c     0u
/**\} */
...
# include "Cdd_MemMap.h"    /* PRQA S 5087 */       /* MD_MSR_MemMap */
/*lint -restore */
