...
#define FLSLOADER_NUM_OF_PF0_SECTORS     (128U)

#define FLSLOADER_PFLASH1_START_ADDRESS  ((uint32)(0xa0300000U))
#define FLSLOADER_PFLASH1_END            ((FlsLoader_AddressType)(0xa04fffffU))
#define FLSLOADER_PFLASH1_SIZE           (0x200000U)
#define FLSLOADER_NUM_OF_PF1_SECTORS     (128U)

#define FLSLOADER_DFLASH0_START_ADDRESS  ((FlsLoader_AddressType)(0xaf000000U))
#define FLSLOADER_DFLASH0_END            ((FlsLoader_AddressType)(0xaf01ffffU))
#define FLSLOADER_DFLASH0_BANK_SIZE      (0x20000U)
#define FLSLOADER_NUM_OF_DF0_SECTORS     (32U)
...
*/
#define FLSLOADER_LOCK_UNLOCK_API        (STD_ON)
