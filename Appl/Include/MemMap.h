...
/* Dem module not used in Boot slim — Dem_MemMap.h removed */
...
/* WRITEERASE must run from PSPR (vLinkGen FlsLoader_WriteErase COPY_TO_RAM). */
#ifdef FLSLOADER_START_SEC_WRITEERASE_CODE_QM_LOCAL
  #undef FLSLOADER_START_SEC_WRITEERASE_CODE_QM_LOCAL
  #pragma section code "FlsLoader_WriteErase"
  #undef MEMMAP_ERROR
#endif
...
/* FiM module not used in Boot slim — FiM_MemMap.h removed */
