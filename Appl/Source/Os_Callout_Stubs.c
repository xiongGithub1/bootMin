 ...
 *   Generation Time: 2026-08-17 16:16:31
 ...
 *********************************************************************************************************************/
  (void)Fatalerror;
  /* EcuM_Shutdown() removed ??? no EcuM in Boot slim */
/**********************************************************************************************************************
 * DO NOT CHANGE THIS COMMENT!           </USERBLOCK>
 *********************************************************************************************************************/
 ...
 *********************************************************************************************************************/
  ...
  volatile OSServiceIdType lastService;
  volatile uint8 endless = 1u;

  (void)Os_GetDetailedError(&CurrentError);
  lastError = CurrentError.Error;       /* e.g. E_OS_LIMIT == 0x04 */
  lastService = CurrentError.Service; /* e.g. OSServiceId_ActivateTask */
  (void)lastError;
  (void)lastService;
